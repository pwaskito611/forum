<div>
    <div class="container mx-auto lg:px-60">
        <div class="mt-10 bg-white py-4 pl-4 pr-4 rounded border">
            ...
            <form action="{{url('update/thread')}}" method="post">
                @csrf 
                @method('put')
               ...
               <center> 
                <!--title-->
                 ...
                 placeholder="Title" style="width: 98%;" value="{{$title}}" required>
                 <!--end title-->
                
                 <!--content-->
                 <textarea wire:model="content" class="bg-gray-100 h-60 rounded border text-left whitespace-pre-line" 
