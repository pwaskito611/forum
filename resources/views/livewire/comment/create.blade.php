<div class="bg-white rounded border container mx-auto px-2 py-2" id="add-comment-form">
    <h1 class="text-2xl"><i class="fas fa-comment-dots"></i> Tambahkan Balasan</h1>
    <form method="POST" action="{{url('store/comment')}}">
      @csrf
      <input type="hidden" name="thread_id" value="{{$threadID}}">
        <textarea class="mt-2 bg-gray-100 h-60 whitespace-pre-line w-full" 
        id="add-comment" name="comment" placeholder="Balasan Anda">   
        </textarea><br>
